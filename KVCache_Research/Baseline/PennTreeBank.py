...
from KVCache_Research.Baseline.config import model_name, device, infer_baseline, num_experiments
import numpy as np

# 定义本地数据集路径
local_dataset_path = "./datasets/ptb_text_only"

# 加载测试集
dataset = get_dataset("ptb_text_only", local_dataset_path, split="test")
